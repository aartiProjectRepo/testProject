...
;-----------------------------------------------------------------------------
	...
	.dw	#__sGRAMA.data,	#__eGRAMA.data,	#__sGRAMA.data.R
	.dw	#__sRRAM.data,	#__eRRAM.data,	#__sRRAM.data.R
	.dw	#__sGRAMB.data,	#__eGRAMB.data,	#__sGRAMB.data.R
...
.section "GRAMA.data", data
.L.dummy.GRAMA.data:
.section "GRAMA.bss", bss
.L.dummy.GRAMA.bss:

.section "GRAMB.data", data
.L.dummy.GRAMB.data:
.section "GRAMB.bss", bss
.L.dummy.GRAMB.bss:

.section "RRAM.data", data
.L.dummy.RRAM.data:
.section "RRAM.bss", bss
.L.dummy.RRAM.bss:
