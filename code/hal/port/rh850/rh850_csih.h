...
/* Selects the data length for chip select signal m (CSIHnDLSm3,CSIHnDLSm2,CSIHnDLSm1,CSIHnDLSm0) */
#define _CSIH_DATA_LENGTH_16                      (0x00000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_1                       (0x01000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_2                       (0x02000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_3                       (0x03000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_4                       (0x04000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_5                       (0x05000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_6                       (0x06000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_7                       (0x07000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_8                       (0x08000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_9                       (0x09000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_10                      (0x0A000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_11                      (0x0B000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_12                      (0x0C000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_13                      (0x0D000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_14                      (0x0E000000UL) /* Selects the data length for chip select signal */
#define _CSIH_DATA_LENGTH_15                      (0x0F000000UL) /* Selects the data length for chip select signal */
